...
public class NextChapterButton extends VideoPlayerButton {
    ...
    public NextChapterButton (int x, int y, int width, int height, VideoPlayerButton playBtn)
    {
    ...
    {
        SceneManager.getCurrentScene().getPlayer().nextChapter();
    }
    ...
    public void drawButton(Graphics2D g2d) {
        ...
        g2d.fillRect(symbolsRect.x+symbolsRect.width-symbolsRect.width/3-symbolsRect.width/8, symbolsRect.y+symbolsRect.height/3, symbolsRect.width/8, symbolsRect.height/3);
    }
}
...
public class InformationPanelGraphics {
    ...
    private void paintSeparator (Graphics2D paint)
    {
        ...
        paint.drawLine(0, SceneManager.getScreenHeight()-PANEL_HEIGHT+1,
                       SceneManager.getScreenWidth(), SceneManager.getScreenHeight()-PANEL_HEIGHT+1);
    }
    
    private void paintTopPanel (Graphics2D paint)
    {
        final Color[] backgroundGradient = {Scene.getDarkerMenuColor(1), new Color(0, 0, 0, 0)};
        ...
        final Color[] separatorGradient = {Scene.getDarkerMenuColor(3), new Color(0, 0, 0, 0)};
